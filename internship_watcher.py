#!/usr/bin/env python3
"""
Internship Watcher - Monitors Summer 2026 internship repository for new listings
and sends email notifications when new internships are found.
"""
...
class InternshipWatcher:
    ...
    def _create_email_html(self, internships: List[Dict[str, str]]) -> str:
        ...
        html += """
            ...
            <p><em>This email was sent by your Internship Watcher script.</em></p>
        </body>
        </html>
        """
    ...
    def _create_email_text(self, internships: List[Dict[str, str]]) -> str:
        ...
        text += "This email was sent by your Internship Watcher script."
...
def main():
    ...
    try:
        ...
        schedule.every(30).minutes.do(watcher.check_for_new_internships)
        
        # Run once immediately
        logging.info("Starting Internship Watcher...")
        watcher.check_for_new_internships()
        
        # Keep the script running
        logging.info("Watcher started. Checking every 30 minutes...")
        while True:
            schedule.run_pending()
            time.sleep(60)  # Check every minute for scheduled jobs
            
    except KeyboardInterrupt:
        logging.info("Internship Watcher stopped by user")
    except Exception as e:
